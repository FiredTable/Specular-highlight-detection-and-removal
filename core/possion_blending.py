...
if __name__ == "__main__":
    offset = (40, -30)
    img_mask = io.imread('../pbimg/balloonmask.png', as_gray=True)
    img_src = io.imread('../pbimg/balloon.png').astype(np.float64)
    img_target = io.imread('../pbimg/balloon_collosseum.png')
